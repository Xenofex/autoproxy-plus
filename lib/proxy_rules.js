...
function getParsedRules(gfwlistURL, ignoreCache, callback) {
    ...
    if (!ignoreCache && cachedAt && (new Date() - new Date(cachedAt) < SubscriptionExpiration) && ss.storage.subscriptionCache) {
